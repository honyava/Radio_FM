...
module fm_demod_imp_KT0QRV
  ...
  fm_hdmi_cic_compiler_0_0 cic_compiler_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_hdmi_cic_compiler_0_1 cic_compiler_1
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_hdmi_cmpy_0_1 cmpy_1
       (.aclk(adc_dci_0_1),
        ...
        .s_axis_a_tdata(LTC_2208_0_m_axis_tdata),
        .s_axis_a_tvalid(LTC_2208_0_m_axis_tvalid),
  ...
  fm_hdmi_del_m_0_0 del_m_0
       (.aclk(adc_dci_0_1),
        ...
        .out0(del_m_0_out0),
        .out1(del_m_0_out1),
        .tap_i(cic_compiler_0_m_axis_data_tdata),
        .tap_q(cic_compiler_1_m_axis_data_tdata),
        .valid(del_m_0_valid));
  fm_hdmi_ila_0_0 ila_0
       (.clk(adc_dci_0_1),
        .probe0(cordic_0_m_axis_dout_tdata),
        .probe1(cmpy_1_m_axis_dout_tdata[15:0]),
