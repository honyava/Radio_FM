...
//Command     : generate_target packer_udp2_inst_3.bd
//Design      : packer_udp2_inst_3
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "packer_udp2_inst_3,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=packer_udp2_inst_3,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=/home/reting/Desktop/Github/Radio_FM/ltc2208_max5885.gen/sources_1/bd/fm_hdmi/bd/packer_udp2_inst_1/packer_udp2_inst_1.bd,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "packer_udp2_inst_3.hwdef" *) 
module packer_udp2_inst_3
   (dout,
    empty,
    rd_clk,
    rd_data_count,
  ...
  packer_udp2_inst_3_fifo_generator_audio_0 fifo_generator_audio
  ...
  packer_udp2_inst_3_mpx_pack16_to32_0_0 mpx_pack16_to32_0
       (.clk(adc_dci_0_1),
  ...
  packer_udp2_inst_3_util_vector_logic_1_0 util_vector_logic_1
