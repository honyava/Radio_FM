...
//Date        : Tue Apr  7 14:25:25 2026
//Host        : reting-ThinkBook-14-G7-IAH running 64-bit Ubuntu 24.04.4 LTS
//Command     : generate_target fm_demod2_inst_3.bd
//Design      : fm_demod2_inst_3
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module Dec200_imp_AYO3WM
   (adc_clk,
    m_axis_i,
    m_axis_q,
    m_axis_tvalid,
  ...
  fm_demod2_inst_3_axis_iq_slicer_to_2c_0_0 axis_iq_slicer_to_2c_0
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_3_cic_compiler_2_0 cic_compiler_2
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_3_cic_compiler_3_0 cic_compiler_3
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_3_fir_compiler_0_0 fir_compiler_0
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_3_fir_compiler_1_0 fir_compiler_1
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_3_iq16_truncate_0_0 iq16_truncate_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_3_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(fir_compiler_0_m_axis_data_tvalid),
        .Op2(fir_compiler_1_m_axis_data_tvalid),
        .Res(util_vector_logic_0_Res));
  fm_demod2_inst_3_xlconcat_0_0 xlconcat_0
       (.In0(fir_compiler_0_m_axis_data_tdata),
        .In1(fir_compiler_1_m_axis_data_tdata),
        .dout(xlconcat_0_dout));
  fm_demod2_inst_3_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  fm_demod2_inst_3_xlslice_0_0 xlslice_0
       (.Din(iq16_truncate_0_m_axis_tdata),
        .Dout(xlslice_0_Dout));
  fm_demod2_inst_3_xlslice_1_0 xlslice_1
       (.Din(iq16_truncate_0_m_axis_tdata),
        .Dout(xlslice_1_Dout));
endmodule

module dec384to192_blockDC_imp_ZY8L8R
   (S_AXIS_DATA_tdata,
    S_AXIS_DATA_tvalid,
    adc_clk,
    m_axis_tdata_0,
  ...
  fm_demod2_inst_3_axis_dc_blocker_roun_0_0 axis_dc_blocker_roun_0
       (.aclk(adc_clk_1),
  ...
  fm_demod2_inst_3_dec384to192_0 dec384to192
       (.aclk(adc_clk_1),
...
module demodulate_384k_imp_FO5ZSV
   (M_AXIS_DOUT_tdata,
    M_AXIS_DOUT_tvalid,
    adc_clk,
    s_axis_ctrl_tdata,
  ...
  assign sys_rst_n_0_1 = sys_rst_n;
  fm_demod2_inst_3_cmpy_0_0 cmpy_0
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_3_cordic_1_0 cordic_1
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_3_del_m_0_0 del_m_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
        .out0(del_m_0_out0),
        .out1(del_m_0_out1),
...
module digital_mixer_imp_1GEEU66
   (adc_clk,
    m_axis_mixer,
    m_axis_mixer_tvalid,
    m_axis_tready,
  ...
  fm_demod2_inst_3_cmpy_1_0 cmpy_1
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
        ...
        .s_axis_ctrl_tdata(lfsr_rng_0_m_axis_tdata),
        .s_axis_ctrl_tvalid(lfsr_rng_0_m_axis_tvalid));
  fm_demod2_inst_3_dds_compiler_0_0 dds_compiler_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_3_fm_dds_cfg_0_0 fm_dds_cfg_0
       (.clk(adc_dci_0_1),
...
(* CORE_GENERATION_INFO = "fm_demod2_inst_3,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fm_demod2_inst_3,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=25,numReposBlks=21,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=/home/reting/Desktop/Github/Radio_FM/ltc2208_max5885.gen/sources_1/bd/fm_hdmi/bd/fm_demod2_inst_0/fm_demod2_inst_0.bd,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "fm_demod2_inst_3.hwdef" *) 
module fm_demod2_inst_3
   (adc_clk,
    adc_data,
    locked,
    m_axis_tdata,
  ...
  dec384to192_blockDC_imp_ZY8L8R dec384to192_blockDC
       (.S_AXIS_DATA_tdata(demodulate_384k_M_AXIS_DOUT_TDATA),
        .S_AXIS_DATA_tvalid(demodulate_384k_M_AXIS_DOUT_TVALID),
        .adc_clk(adc_clk_1),
        ...
        .probe_out0(vio_0_probe_out0));
  demodulate_384k_imp_FO5ZSV demodulate_384k
       (.M_AXIS_DOUT_tdata(demodulate_384k_M_AXIS_DOUT_TDATA),
        ...
        .tap_i(cic_compiler_2_m_axis_data_tdata),
        .tap_q(cic_compiler_3_m_axis_data_tdata));
  digital_mixer_imp_1GEEU66 digital_mixer
       (.adc_clk(adc_clk_1),
