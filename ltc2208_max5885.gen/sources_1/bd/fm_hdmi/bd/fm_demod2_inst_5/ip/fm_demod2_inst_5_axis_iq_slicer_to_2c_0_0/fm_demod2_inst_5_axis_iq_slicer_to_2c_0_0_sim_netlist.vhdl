...
-- Command     : write_vhdl -force -mode funcsim -rename_top fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 -prefix
--               fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0_ fm_demod2_inst_8_axis_iq_slicer_to_2c_0_0_sim_netlist.vhdl
...
entity fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0_axis_iq_slicer_to_2cic is
  port (
...
end fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0_axis_iq_slicer_to_2cic;

architecture STRUCTURE of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0_axis_iq_slicer_to_2cic is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 : entity is "fm_demod2_inst_8_axis_iq_slicer_to_2c_0_0,axis_iq_slicer_to_2cic,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 : entity is "axis_iq_slicer_to_2cic,Vivado 2023.2";
end fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0;

architecture STRUCTURE of fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0 is
...
inst: entity work.fm_demod2_inst_5_axis_iq_slicer_to_2c_0_0_axis_iq_slicer_to_2cic
     port map (
      aresetn => aresetn,
