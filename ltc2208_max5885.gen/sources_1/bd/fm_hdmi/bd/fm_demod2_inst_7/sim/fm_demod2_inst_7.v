...
module Dec200_imp_94Z10F
  ...
  fm_demod2_inst_7_axis_iq_slicer_to_2c_0_0 axis_iq_slicer_to_2c_0
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_7_cic_compiler_2_0 cic_compiler_2
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_7_cic_compiler_3_0 cic_compiler_3
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_7_fir_compiler_0_0 fir_compiler_0
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_7_fir_compiler_1_0 fir_compiler_1
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_7_iq16_truncate_0_0 iq16_truncate_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_7_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(fir_compiler_0_m_axis_data_tvalid),
        .Op2(fir_compiler_1_m_axis_data_tvalid),
        .Res(util_vector_logic_0_Res));
  fm_demod2_inst_7_xlconcat_0_0 xlconcat_0
       (.In0(fir_compiler_0_m_axis_data_tdata),
        .In1(fir_compiler_1_m_axis_data_tdata),
        .dout(xlconcat_0_dout));
  fm_demod2_inst_7_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  fm_demod2_inst_7_xlslice_0_0 xlslice_0
       (.Din(iq16_truncate_0_m_axis_tdata),
        .Dout(xlslice_0_Dout));
  fm_demod2_inst_7_xlslice_1_0 xlslice_1
       (.Din(iq16_truncate_0_m_axis_tdata),
        .Dout(xlslice_1_Dout));
endmodule
...
module dec384to192_blockDC_imp_11GBTSI
  ...
  fm_demod2_inst_7_axis_dc_blocker_roun_0_0 axis_dc_blocker_roun_0
       (.aclk(adc_clk_1),
  ...
  fm_demod2_inst_7_dec384to192_0 dec384to192
       (.aclk(adc_clk_1),
...
module demodulate_384k_imp_HI723Q
  ...
  assign sys_rst_n_0_1 = sys_rst_n;
  fm_demod2_inst_7_cmpy_0_0 cmpy_0
       (.aclk(adc_dci_0_1),
  ...
  fm_demod2_inst_7_del_m_0_0 del_m_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
        .out0(del_m_0_out0),
        .out1(del_m_0_out1),
...
module digital_mixer_imp_1G31PGN
   (adc_clk,
    m_axis_mixer,
    m_axis_mixer_tvalid,
    m_axis_tready,
  ...
  fm_demod2_inst_7_cmpy_1_0 cmpy_1
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
        ...
        .s_axis_ctrl_tdata(lfsr_rng_0_m_axis_tdata),
        .s_axis_ctrl_tvalid(lfsr_rng_0_m_axis_tvalid));
  fm_demod2_inst_7_dds_compiler_0_0 dds_compiler_0
       (.aclk(adc_dci_0_1),
        .aresetn(sys_rst_n_0_1),
  ...
  fm_demod2_inst_7_lfsr_rng_0_0 lfsr_rng_0
       (.clk(adc_dci_0_1),
...
(* CORE_GENERATION_INFO = "fm_demod2_inst_7,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fm_demod2_inst_7,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=25,numReposBlks=21,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=/home/reting/Desktop/Github/Radio_FM/ltc2208_max5885.srcs/sources_1/bd/fm_demod2/fm_demod2.bd,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "fm_demod2_inst_7.hwdef" *) 
module fm_demod2_inst_7
   (adc_clk,
    adc_data,
    locked,
    m_axis_tdata,
  ...
  demodulate_384k_imp_HI723Q demodulate_384k
       (.M_AXIS_DOUT_tdata(demodulate_384k_M_AXIS_DOUT_TDATA),
        ...
        .tap_i(cic_compiler_2_m_axis_data_tdata),
        .tap_q(cic_compiler_3_m_axis_data_tdata));
  digital_mixer_imp_1G31PGN digital_mixer
       (.adc_clk(adc_clk_1),
