...
#
# Script generated by Vivado on Fri Feb 20 11:48:24 MSK 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../ltc2208_max5885.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../ltc2208_max5885.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/reting/Desktop/LTC2208_MAX5885_without_dci/ltc2208_max5885.cache/compile_simlib/vcs"
  fi
